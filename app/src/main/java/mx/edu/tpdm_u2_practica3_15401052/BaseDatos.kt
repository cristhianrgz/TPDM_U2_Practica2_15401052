...
class BaseDatos(
    ...
    override fun onCreate(p0: SQLiteDatabase?) {
        p0?.execSQL("CREATE TABLE CLIENTES(IDCLIENTE INTEGER PRIMARY KEY AUTOINCREMENT, NOTELEFONO VARCHAR(30), NOMBRE VARCHAR(400), DOMICILIO VARCHAR(400), IDEMPRESA INTEGER, FOREIGN KEY(IDEMPRESA) REFERENCES EMPRESA(IDEMPRESA))")
